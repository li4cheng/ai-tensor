        ...
        <div class="aside-content">
          <div class="titleBox">
            <el-input placeholder="输入关键字进行过滤" clearable prefix-icon="el-icon-search" size="mini" v-model="filterText">
              <el-button size="mini" slot="append" @click="onAddItem(4)">
              ...
              <div slot-scope="{ node, data }" class="dict-item">
                ...
                <el-dropdown class="more" @command="onCommand($event, data)">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="add" v-permission="'dictTypeMan:btn_add'">添加</el-dropdown-item>
                    <el-dropdown-item command="upd" v-permission="'dictTypeMan:btn_edit'">编辑</el-dropdown-item>
                    <el-dropdown-item command="del" v-permission="'dictTypeMan:btn_delete'">删除</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </div>
            </el-tree>
      ...
      <el-col :span="19" style="height:100%">
        <div class="app-container">
          <div class="filter-container">
            <el-form :model="listDictValueQuery" ref="listForm" :inline="true" class="form">
              <el-form-item prop="keyword" label="关键字">
                <el-input type="text" size="mini" style="width: 200px;" placeholder="值/编码" v-model="listDictValueQuery.keyword" clearable></el-input>
              </el-form-item>
              <el-form-item>
          ...
          <div class="common-tool">
            ...
            <div class="right">
              <el-button class="txt-btn" size="mini" @click="onItemAdd" type="text" icon="el-icon-plus" v-permission="'dictValueMan:btn_add'">添加</el-button>
              <el-button class="txt-btn" style="margin-left:0px" v-permission="'dictValueMan:btn_delete'" size="mini" icon="el-icon-delete" type="text" @click="onItemDelete">删除</el-button>
            </div>
          </div>
          <el-table :data="dictValueTableData.rows" border highlight-current-row fit style="width: 100%" height="calc(100vh - 302px)" @selection-change="onListChange">
            <el-table-column type="selection" width="45" />
            <el-table-column fixed="right" label="操作" width="80px" align="center">
              <template slot-scope="scope">
                <el-button type="success" size="mini" @click="onValueEdit(scope.row)" v-permission="'dictValueMan:btn_edit'">编辑</el-button>
              </template>
            </el-table-column>
