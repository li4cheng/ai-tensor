<template>
  <el-tabs type="border-card" class="app-container" @tab-click="onTabsChange" v-model="tabsActive">
    <el-tab-pane label="门禁推送" name="doorManage" v-permission="'pushMan:view_access'">
      <door-manage ref="doorManage" />
    </el-tab-pane>
    <el-tab-pane label="APP推送" name="appManage" v-permission="'pushMan:view_app'">
      <app-manage ref="appManage" />
    </el-tab-pane>
    <el-tab-pane label="短信推送" name="smsManage" v-permission="'pushMan:view_sms'">
      <sms-manage ref="smsManage" />
    </el-tab-pane>
    <el-tab-pane label="客户端推送" name="clientManage" v-permission="'pushMan:view_client'">
