<template>
  <div class="dialog-list">
        ...
        <el-row>
          <el-col :span="4" class="left-box">
            <el-form-item label-width="0" prop="identityImgShow" class="pic">
              <img-show :img-src="form.identityImgShow" txt="暂无证件照" width="120px" height="148px" />
            </el-form-item>
    ...
    <!-- 门牌楼号选择层 -->
    <mlph-select :is-open.sync="isMlphDialog" :data.sync="form.mlph" :disable-type="['1','2']" />
