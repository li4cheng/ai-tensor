<template>
  <div class="menu-container">
    <div class="header-container">
      ...
      <div class="right">
        <a @click="$router.push('/dataCenter/alarmNews')">
    ...
    <div class="sidebar-container">
      <router-link to="/dashboard" class="logo">
        <img v-if="basicInfo.homeLogo" :src="basicInfo.homeLogo + '?r=' + new Date().getTime()">
        <div class="place" v-if="userInfo.departName">
...
import { putChangePassword, getBasicInfo } from "@/api/login";
