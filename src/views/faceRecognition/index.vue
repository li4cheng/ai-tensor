    ...
    <el-tab-pane label="人脸比对">
      ...
      <div class="comparison-box">
        <div class="left-box">
          ...
          <el-button size="small" type="success" @click="onComparisonSubmit" v-permission="'faceRecognitionMan:btn_compare'">开始对比</el-button>
        </div>
        <div class="right-box">
          <el-upload ref="comparisonRightUpload" action="" accept=".jpeg,.jpg,.png,.bmp" :limit="limit" :on-exceed="onUploadExceed" list-type="picture-card" :auto-upload="false" :multiple="true">
    ...
    <el-tab-pane label="人脸检测">
      ...
      <div class="location-box">
        <div class="left-box">
          ...
          <el-button size="small" class="input-w" type="success" @click="onLocationSubmit" v-permission="'faceRecognitionMan:btn_detect'">开始分析</el-button>
          <el-button size="small" type="danger" @click="onLocationSubmit('deep')" v-permission="'faceRecognitionMan:btn_deep_detect'">深度分析</el-button>
        </div>
...
<script>
import imgCalibration from "@/utils/fileUtil";
          ...
          reader.addEventListener("load", () => {
            ...
            if (_index === _files.length) {
              ...
              postFaceCompare(this.comparison.form).then(res => {
                ...
                this.comparison.data = res.data.data;
              });
            }
          });
        });
      ...
      if (!this.location.form.image) {
        ...
        if (val === "deep") {
          ...
          postFaceDeepDetect(this.location.form).then(res => {
            ...
            this.location.deepData = res.data.data;
          ...
          postFaceDetect(this.location.form).then(res => {
            ...
            this.location.data = res.data.data;
