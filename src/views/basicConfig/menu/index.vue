          ...
          <div class="menu-item" slot-scope="{ node, data }">
            ...
            <el-dropdown @command="onCommand($event, data)" class="more">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="add" v-permission="'menuMan:btn_add'">添加</el-dropdown-item>
                <el-dropdown-item command="upd" v-permission="'menuMan:btn_edit'">编辑</el-dropdown-item>
                <el-dropdown-item command="del" v-permission="'menuMan:btn_delete'">删除</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
        </el-tree>
...
import {
  ...
  deleteMenu,
  putMenu
} from "@/api/basicConfig/menuManage/index";
