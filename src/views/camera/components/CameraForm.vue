<template>
  <div class="camera-form">
    <el-dialog title="摄像头" class="body0" :visible.sync="isFormDialog" width="800px">
        ...
        <el-tabs v-model="tabsValue" tab-position="left">
          <el-tab-pane label="基本信息" name="first">
            <el-row class="first-box">
              ...
              <el-col :span="12">
                <el-form-item label="位置照片" prop="cameraImage">
              ...
              <el-col :span="12" v-permission="'cameraMan:btn_update_status'">
          ...
          <el-tab-pane label="推送参数" name="third">
            <el-row class="third-box">
              <el-col :span="24" class="heading">
                <el-checkbox v-model="form.apeFlag" :true-label="1" :false-label="0">中心联动</el-checkbox>
                <el-form-item prop="apeFlag" class="m0" />
              </el-col>
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="apeNums" class="m0">
                  <el-select v-model="arrForm.apeArr" placeholder="请选择" multiple collapse-tags>
                    <el-option v-for="item in labelTypeData" :key="item.num" :label="item.label" :value="item.num+''" />
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="注册码" prop="apeCode" class="m0">
                  <el-input :value="form.apeCode" placeholder="请输入注册码" disabled />
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="callbackNums">
              ...
              <el-col :span="12">
                <el-form-item label="推送地址" prop="callbackUrl">
                  <el-input v-model="form.callbackUrl" placeholder="请输入回调地址" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="推送频率(秒)" prop="callbackFrequency" class="m0">
                  <el-input v-model.number="form.callbackFrequency" placeholder="请输入推送频率" />
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="accessNums" class="m0">
              ...
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="smsNums" class="m0">
              ...
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="appNums" class="m0">
              ...
              <el-col :span="12">
                <el-form-item label="作用标签类型" prop="voiceNums" class="m0">
...
export default {
  ...
  data: () => ({
    ...
    rules: {
      cameraCode: { required: true, message: "请输入编码" },
      cameraName: { required: true, message: "请输入名称" },
      cameraBrand: { required: true, message: "请输入品牌" },
      cameraIp: { required: true, message: "请输入摄像头ip" },
      cameraPort: { required: true, message: "请输入摄像头端口" },
      mapPosition: { required: true, message: "请选择区域坐标" },
      lng: { required: true, message: "请选择经纬度" },
      cameraStatus: { required: true, message: "请输入1在线 0掉线" },
      cameraAble: { required: true, message: "请输入1启用 0禁用" },
      imgWidth: { required: true, message: "请输入抓拍人脸宽度" },
      imgHeight: { required: true, message: "请输入抓拍人脸高度" },
      bgImgWidth: { required: true, message: "请输入抓拍背景宽度" },
      bgImgHeight: { required: true, message: "请输入抓拍背景高度" }
    },
    labelTypeData: [],
    accessData: [],
    smsData: [],
  ...
  methods: {
    ...
    getFormDetail() {
      this.$store.dispatch("camera/detail", this.id).then(res => {
        if (res.status == 200) {
          ...
          if (res.data.apeNums) {
            this.arrForm.apeArr = res.data.apeNums.split(",");
          }
    ...
    onSubmit() {
      this.$refs.form.validate((valid, errArr) => {
        ...
        _form.apeNums = this.arrForm.apeArr.join(",");
