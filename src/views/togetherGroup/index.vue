  ...
  <div class="app-container">
    ...
    <el-table :data="listTableData.rows" class="table" v-loading="listTableLoading" height="calc(100vh - 255px)">
      ...
      <el-table-column label="操作" fixed="right" width="100">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="onDetail(scope.row)" v-permission="'snapMan:btn_together_group_detail'">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="同行详情" class="detail-layer body0" :visible.sync="isDialogDateil" width="850px">
      <el-row>
        <el-col :span="9" class="info segmentation">
          <img-show width="80px" height="80px" txt="暂无头像" :img-src="detailData.snapImgBase" />
